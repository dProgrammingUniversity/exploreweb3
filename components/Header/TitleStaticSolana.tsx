// /components/Header/TitleStaticSolana.tsx
import React from "react";

const TitleStaticSolana = () => {
  return (
    <div className="container mx-auto py-8"> {/* Added mx-auto to center the container */}
      <div className="text-center">
        <h1 className="mb-2 text-3xl font-bold text-white md:text-4xl">
          Explore 
          {" "}<span className="text-purple-400">Solana Ecosystem</span> PROJECTS
        ...
        <p className="mt-2 px-4 text-sm text-purple-300 md:text-base">
          Experience Solana ecosystem easily, exclusive
...
export default TitleStaticSolana;
