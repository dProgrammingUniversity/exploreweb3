// /components/Directory/Tab/index.tsx
"use client";
import Image from "next/image";
import { useState } from "react";
import DirectoryTabItem from "./DirectoryTabItem";
import DirectoryTabData from "./DirectoryTabData";
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {DirectoryTabData.map((feature, key) => (
              <div
                className={feature.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <DirectoryTabItem featureTab={feature} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
