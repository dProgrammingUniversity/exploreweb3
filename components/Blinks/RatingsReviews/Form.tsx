// /components/Blink/RatingsReviews/Form.tsx
import { SetStateAction, useState } from 'react';
import { createClient } from '@/utils/supabase/client';
import { StarIcon } from '@heroicons/react/24/solid';
import { StarIcon as StarOutlineIcon } from '@heroicons/react/24/outline';

const BlinksRatingReviewsForm = ({ blinksId, userId  }: BlinksRatingReviewsProps) => {
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    const { data, error } = await supabaseClient
      .rpc('blinks_ratings_reviews_insert', { _blinks_id: blinksId,  _user_id: userId, _rating: rating, _review: review });
...
export default BlinksRatingReviewsForm;
