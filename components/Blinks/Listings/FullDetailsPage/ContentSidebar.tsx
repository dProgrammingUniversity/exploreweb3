  ...
  return (
    <div className="md:w-1/2 lg:w-[32%]">
      <div className="animate_top mb-10 rounded-md border border-stroke bg-white p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
        ...
        <span className="block">{listing.blockchain}</span>
      </div>
      ...
      <div className="animate_top mb-10 rounded-md border border-stroke bg-white p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
        ...
        <span className="block">{listing.governance}</span>
      </div>
      ...
      <div className="animate_top mb-10 rounded-md border border-stroke bg-white p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
        ...
        <span className="block">{listing.keyword}</span>
      </div>
      ...
      <div className="animate_top mb-10 rounded-md border border-stroke bg-white p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
        ...
        <span className="block">{listing.tokenomic}</span>
        <span className="block text-green-600">{listing.name} Token Ticker:</span>
        <span className="block">{listing.token_name}</span>
      </div>
      ...
      <div className="animate_top mb-10 rounded-md border border-stroke bg-white p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
        ...
        <span className="block">{listing.nft_collection}</span>
