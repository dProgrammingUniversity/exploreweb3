  ...
  return (
    <>
      <h1 className="text-2xl font-bold text-center my-6 text-purple-500">
        WHAT IS ExploreSolana PLATFORM ABOUT
      </h1>
      ...
      <p className="text-md mb-4 text-justify">
        ExploreSolana is a comprehensive platform designed (serves as a
        non-token/non-financial launchpad) for upcoming and existing Solana
        projects to reach and acquire (new/more) users.
      </p>
      <p className="text-md mb-4 text-justify">
        And for the users (also earn contributing to the platform), ExploreSolana
      ...
      <p className="text-md mb-4 text-justify">
        ExploreSolana platform is not just another regular solana project directory
        ...
        features and solutions that ExploreSolana aim to offer the existing Solana
      ...
      <h2 className="text-2xl font-bold my-6 text-purple-500">
        B. PROBLEMS AND SOLUTIONS OFFERED BY ExploreSolana:
      </h2>
      <p className="text-md mb-4 text-justify">
      ...
      <div className="my-6">
        <h2 className="text-2xl font-bold my-6 text-purple-500">
          D. EARNING OPPORTUNITIES ON ExploreSolana:
        </h2>
        <p>
          ExploreSolana is not only about Solana projects discovery and engagement
        ...
        <ol>
          ...
          <li>
            ...
            <span>
              {" "}
              Earn by referring others to subscribe to the ExploreSolana "S"
              Newsletter.
            </span>
          </li>
          <li>
...
const problemsAndSolutions = [
  ...
  },
  {
    ...
    solution:
      "Nope, every solana project deserves a launchpad-like platform (not financially focused but user acquisition aspect) where they can feature their projects to Solana enthusiasts to gain community even before launching the project as long as the project serves or solves problems within the Solana ecosystem and ExploreSolana is the platform to make this a reality.",
  },
  {
    title:
  ...
  },
  {
    ...
    solution:
      "ExploreSolana features advanced search capabilities and micro-categories, allowing for easy navigation and discovery based on user interests and needs. Our platform includes an intuitive search feature and categorization for over 1,000 Solana projects, simplifying the discovery process.",
  },
  {
    ...
    solution:
      "Yes, there are usually multiple projects doing the same/similar things within the Solana ecosystem, so why get stuck to one or turned off totally due to a bad experience with one project when there are alternatives that might even be better? ExploreSolana includes a section for alternative and similar projects on each Solana project full details page, ensuring users can easily find and compare options.",
  },
