...
export default function EarnPage() {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <p className="text-md mb-4 text-justify">
        See the existing earning paths and amount of dPUT reward each can earn you on ExploreSol platform below:
      </p>
      <div>
      ...
      <div className="my-6">
        <h2 className="text-2xl font-bold my-6 text-purple-500">
          C. WHAT IS EXPLORESOL dPUT REWARD TOKEN:
        </h2>
        <p>
        ...
        <p>Want to learn more and how to exchange your earned dPUT for SOL?</p>
...
const problemsAndSolutions = [
  ...
  },
  {
    ...
    reward:
      "20%(200Million) of dPUT 1Billion Max Supply is planned towards community rewards for users and contributors to Solana projects across dProgramming University (dPU) ecosystem",
  },
